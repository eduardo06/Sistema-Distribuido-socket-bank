...
def     conexionAcuerdoSend(_mensaje):
    ...
    clientA.connect(('192.168.1.12',8000)) 
...
def conexionAcuerdoRecv():     
    ...
    while True:        
        ...
        if(msgTrue == 'True' and cuenta == cuentaActiva):
            ...
            client.connect(('192.168.1.12',8000))     
...
def conexion(n_cuenta):
    ...
    if (banco == "A"):
        remoteBank =Client('http://192.168.1.10:1515/WS/Bank_A?wsdl')
    elif (banco == "B"):
        remoteBank =Client('http://192.168.1.12:1520/WS/Bank_B?wsdl')
    elif (banco == "C"):
        remoteBank =Client('http://192.168.1.16:1525/WS/Bank_C?wsdl')    
...
if __name__ == "__main__":                
    ...
    bancoA =Client('http://192.168.1.10:1515/WS/Bank_A?wsdl')
